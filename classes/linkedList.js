export default class LinkedList {
  ...
  contains(value) {
    ...
    let temp = this.nextNode;
    // while (temp.value.key !== value && temp.nextNode) {
    while (getObjectsKey(temp.value) !== value && temp.nextNode) {
      temp = temp.nextNode;
    }
    // console.log("temp:", temp.value.key);
    return getObjectsKey(temp.value) == value ? true : false;
  }
